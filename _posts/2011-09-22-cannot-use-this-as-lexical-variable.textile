---
layout: post
title: "How to solve: Cannot use $this as lexical variable"
---

Since the beginning of version 5.3, PHP introduced Closures. People familiar with JavaScript might refer to them as _anonymous functions_. These closures allow you to do something like this:
